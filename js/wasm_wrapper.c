/* wasm_wrapper.c
 *
 * webassembly export wrapper for 128-bit double-double values.
 * exposes internal c-core math directly to javascript.
 *
 * updated 2026-08-09
...
WASM_BIN_ARRAY_OP(sub, simd_f128_sub)
WASM_BIN_ARRAY_OP(mul, simd_f128_mul)
WASM_BIN_ARRAY_OP(div, simd_f128_div)
