...
emcc wasm_wrapper.c -O3 -s WASM=1 \
    -s EXPORTED_FUNCTIONS="['_simd_f128_wasm_add', '_simd_f128_wasm_sub', '_simd_f128_wasm_mul', '_simd_f128_wasm_div', '_simd_f128_wasm_from_string', '_simd_f128_wasm_to_string', '_malloc', '_free']" \
