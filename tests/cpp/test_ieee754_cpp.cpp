...
int main() {
    ...
    if (test_nan_ops()) {
        std::cout << "  [PASS] test_nan_ops" << std::endl;
        passed++;
    } else {
        std::cout << "  [FAIL] test_nan_ops" << std::endl;
        failed++;
    }

    if (test_infinity_ops()) {
        std::cout << "  [PASS] test_infinity_ops" << std::endl;
        passed++;
    } else {
        std::cout << "  [FAIL] test_infinity_ops" << std::endl;
        failed++;
    }

    if (test_comparisons()) {
        std::cout << "  [PASS] test_comparisons" << std::endl;
        passed++;
    } else {
        std::cout << "  [FAIL] test_comparisons" << std::endl;
        failed++;
    }
