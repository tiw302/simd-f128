...
public:
    ...
    SIMD_F128_DEVICE float128 operator-() const { return float128(simd_f128_neg(data)); }
...
SIMD_F128_DEVICE inline float128 operator+(double a, const float128& b) { return float128(a) + b; }
SIMD_F128_DEVICE inline float128 operator-(double a, const float128& b) { return float128(a) - b; }
SIMD_F128_DEVICE inline float128 operator*(double a, const float128& b) { return float128(a) * b; }
SIMD_F128_DEVICE inline float128 operator/(double a, const float128& b) { return float128(a) / b; }

SIMD_F128_DEVICE inline bool operator==(double a, const float128& b) { return float128(a) == b; }
SIMD_F128_DEVICE inline bool operator!=(double a, const float128& b) { return float128(a) != b; }
SIMD_F128_DEVICE inline bool operator>(double a, const float128& b) { return float128(a) > b; }
SIMD_F128_DEVICE inline bool operator<(double a, const float128& b) { return float128(a) < b; }
SIMD_F128_DEVICE inline bool operator>=(double a, const float128& b) { return float128(a) >= b; }
...
SIMD_F128_DEVICE inline float128 tan(float128 x) { return float128(simd_f128_tan(x.data)); }
SIMD_F128_DEVICE inline float128 sinh(float128 x) { return float128(simd_f128_sinh(x.data)); }
SIMD_F128_DEVICE inline float128 cosh(float128 x) { return float128(simd_f128_cosh(x.data)); }
SIMD_F128_DEVICE inline float128 tanh(float128 x) { return float128(simd_f128_tanh(x.data)); }
SIMD_F128_DEVICE inline void sincos(float128 x, float128* s, float128* c) { simd_f128_sincos(x.data, &s->data, &c->data); }
...
public:
    ...
    static f128::float128 min() noexcept { return f128::float128(simd_f128_from_hi_lo(2.2250738585072014e-308, 0.0)); } // normalized min
    ...
    static f128::float128 denorm_min() noexcept { return f128::float128(simd_f128_from_hi_lo(4.9406564584124654e-324, 0.0)); }
};
...
inline f128::float128 tan(f128::float128 x) { return f128::tan(x); }
inline f128::float128 sinh(f128::float128 x) { return f128::sinh(x); }
...
inline f128::float128 trunc(f128::float128 x) { return f128::trunc(x); }
inline f128::float128 round(f128::float128 x) { return f128::round(x); }
inline f128::float128 fmod(f128::float128 a, f128::float128 b) { return f128::fmod(a, b); }
inline f128::float128 atan(f128::float128 x) { return f128::atan(x); }
inline f128::float128 atan2(f128::float128 y, f128::float128 x) { return f128::atan2(y, x); }
inline f128::float128 asin(f128::float128 x) { return f128::asin(x); }
inline f128::float128 acos(f128::float128 x) { return f128::acos(x); }
inline bool isnan(f128::float128 x) { return f128::isnan(x); }
inline bool isinf(f128::float128 x) { return f128::isinf(x); }
